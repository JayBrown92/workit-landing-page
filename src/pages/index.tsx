...
export default function Home() {
  return (
    <>
      ...
      AI-generated reports help you unlock insights hidden in your product data.
      ...
      costs or unexpected fees. Be the first to test Hi, I&apos;m Louis Graham,
      the founder of the company. Book a demo call with me to become a beta
      tester for our app and kickstart your company. Apply for access below and
      I&apos;ll be in touch to schedule a call. Apply for access
    </>
  );
}
